...
export default function AssetManagersDemo() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <section className="pb-12">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="max-w-3xl">
            <Badge className="bg-green-900/20 text-green-300 hover:bg-green-900/30 border border-green-800/30 mb-4">
            ...
            <p className="text-xl text-slate-300 leading-relaxed">
              Example of a portfolio analytics dashboard we can build for asset managers.
              Track NOI, occupancy, cap rates, and investor returns across your entire portfolio in real-time.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-slate-800/80 rounded-xl p-6 border border-slate-700/50">
              <h3 className="text-lg font-semibold text-white mb-2">Real-time Portfolio Analytics</h3>
              <p className="text-slate-400">
                Monitor NOI, occupancy, and cap rates across all properties with automatic data aggregation and trend analysis.
              </p>
            </div>
            <div className="bg-slate-800/80 rounded-xl p-6 border border-slate-700/50">
              <h3 className="text-lg font-semibold text-white mb-2">Automated Investor Reporting</h3>
              <p className="text-slate-400">
                Generate professional quarterly reports with one click. Track distributions, IRR, and equity multiples automatically.
              </p>
            </div>
            <div className="bg-slate-800/80 rounded-xl p-6 border border-slate-700/50">
              <h3 className="text-lg font-semibold text-white mb-2">Performance Benchmarking</h3>
              <p className="text-slate-400">
                Compare property performance against portfolio averages and market benchmarks to identify opportunities.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-green-900/50 to-slate-800/50">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg text-slate-300">
              We can integrate with your property management systems, customize KPIs to your investment criteria, and build investor portals for your LPs.
            </p>
            <Button size="lg" className="bg-white text-green-900 hover:bg-slate-100" asChild>
              <a href="https://calendly.com/joe-omnia/30min" target="_blank" rel="noopener noreferrer">
